...
go
/*=================================*/
/* TEST CONTRAINT BikeAvailability */
/*=================================*/
--
/*=======CREATING TEST DATA========*/
BEGIN TRAN --ROLLBACK
...
INSERT INTO STATION(STATIONID, STATIONNR, [ZONE], [TYPE], MAXPOSTS, [LOCATION]) VALUES (100000, 100000, 21, 'normal', 70, 'Paris :)')-- empty test station
...
BEGIN TRAN
--1 good insert
INSERT INTO RENTAL (BIKEID, USERID, BEGINSTATIONID, ENDSTATIONID, INVOICEID, BEGINTIME, ENDTIME, PRICE, EXTENDEDTIME, PAID)
			VALUES (100000, 1, 100000, NULL, NULL, CURRENT_TIMESTAMP, NULL, NULL, NULL, 0)
ROLLBACK
BEGIN TRAN
--1 bad insert, bike in repair
INSERT INTO RENTAL (BIKEID, USERID, BEGINSTATIONID, ENDSTATIONID, INVOICEID, BEGINTIME, ENDTIME, PRICE, EXTENDEDTIME, PAID)
			VALUES (100001, 1, 100000, NULL, NULL, CURRENT_TIMESTAMP, NULL, NULL, NULL, 0)
ROLLBACK
BEGIN TRAN
--1 bad insert, bike's station is locked
INSERT INTO RENTAL (BIKEID, USERID, BEGINSTATIONID, ENDSTATIONID, INVOICEID, BEGINTIME, ENDTIME, PRICE, EXTENDEDTIME, PAID)
			VALUES (100002, 1, 100000, NULL, NULL, CURRENT_TIMESTAMP, NULL, NULL, NULL, 0)
ROLLBACK
BEGIN TRAN
--1 bad insert, bike is being rented
INSERT INTO RENTAL (BIKEID, USERID, BEGINSTATIONID, ENDSTATIONID, INVOICEID, BEGINTIME, ENDTIME, PRICE, EXTENDEDTIME, PAID)
			VALUES (100003, 1, 100000, NULL, NULL, CURRENT_TIMESTAMP, NULL, NULL, NULL, 0)
ROLLBACK
BEGIN TRAN
--2 good inserts
INSERT INTO RENTAL (BIKEID, USERID, BEGINSTATIONID, ENDSTATIONID, INVOICEID, BEGINTIME, ENDTIME, PRICE, EXTENDEDTIME, PAID)
			VALUES (100000, 1, 100000, NULL, NULL, CURRENT_TIMESTAMP, NULL, NULL, NULL, 0),
				   (100004, 2, 100000, NULL, NULL, CURRENT_TIMESTAMP-1, NULL, NULL, NULL, 0)
ROLLBACK
BEGIN TRAN
--2 inserts, 1 good, 1 bad
INSERT INTO RENTAL (BIKEID, USERID, BEGINSTATIONID, ENDSTATIONID, INVOICEID, BEGINTIME, ENDTIME, PRICE, EXTENDEDTIME, PAID)
			VALUES (100000, 1, 100000, NULL, NULL, CURRENT_TIMESTAMP, NULL, NULL, NULL, 0),
				   (100003, 1, 100000, NULL, NULL, CURRENT_TIMESTAMP-1, NULL, NULL, NULL, 0)
ROLLBACK
--END TEST CONTRAINT #1

GO
/*==============================================================*/
/*					Constraintname: MaxPosts					*/
/*	The number of posts in a station can't be more than the		*/
/*					maxPosts value of that staion.				*/
/*==============================================================*/

CREATE TRIGGER trgMaxPosts --DROP TRIGGER trgConstraint2_POST_nPostsLessThanMaxPosts
On POST
AFTER INSERT
AS
BEGIN
...
go
/*=================================*/
/* TEST CONTRAINT MaxBikes */
/*=================================*/
/*=======CREATING TEST DATA========*/
BEGIN TRAN
SET IDENTITY_INSERT STATION ON
INSERT INTO STATION(STATIONID, STATIONNR, [ZONE], [TYPE], MAXPOSTS, [LOCATION]) VALUES (200000, 2000, 2000, 'normal', 4, 'PARIS :)')--
SET IDENTITY_INSERT STATION OFF
SET IDENTITY_INSERT POST ON
...
--1 GOOD INSERT
BEGIN TRAN
INSERT INTO POST(STATIONID, BIKEID, LOCKED) VALUES	(200000, NULL, 0)
ROLLBACK
BEGIN TRAN
--2 GOOD INSERTS
INSERT INTO POST(STATIONID, BIKEID, LOCKED) VALUES	(200000, NULL, 0),
